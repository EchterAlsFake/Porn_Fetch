...
class Ui_Porn_Fetch_Widget(object):
    def setupUi(self, Porn_Fetch_Widget):
        ...
        self.lineedit_file_2 = QLineEdit(self.page_3)
        self.lineedit_file_2.setObjectName(u"lineedit_file_2")
        sizePolicy = QSizePolicy(QSizePolicy.MinimumExpanding, QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lineedit_file_2.sizePolicy().hasHeightForWidth())
        self.lineedit_file_2.setSizePolicy(sizePolicy)
        self.lineedit_file_2.setMinimumSize(QSize(300, 0))

        self.gridlayout_start_download_box_2.addWidget(self.lineedit_file_2, 3, 1, 1, 1)

        self.lineedit_model_url_2 = QLineEdit(self.page_3)
        self.lineedit_model_url_2.setObjectName(u"lineedit_model_url_2")
        sizePolicy.setHeightForWidth(self.lineedit_model_url_2.sizePolicy().hasHeightForWidth())
        self.lineedit_model_url_2.setSizePolicy(sizePolicy)
        self.lineedit_model_url_2.setMinimumSize(QSize(300, 0))

        self.gridlayout_start_download_box_2.addWidget(self.lineedit_model_url_2, 2, 1, 1, 1)

        self.button_model_2 = QPushButton(self.page_3)
        self.button_model_2.setObjectName(u"button_model_2")
        self.button_model_2.setCursor(QCursor(Qt.PointingHandCursor))
        self.button_model_2.setStyleSheet(u"QPushButton {\n"
"    /* Base style */\n"
...
"}")
        ...
        self.gridlayout_start_download_box_2.addWidget(self.button_model_2, 2, 2, 1, 1)

        self.lineedit_url_2 = QLineEdit(self.page_3)
        self.lineedit_url_2.setObjectName(u"lineedit_url_2")
        sizePolicy.setHeightForWidth(self.lineedit_url_2.sizePolicy().hasHeightForWidth())
        self.lineedit_url_2.setSizePolicy(sizePolicy)
        self.lineedit_url_2.setMinimumSize(QSize(300, 0))

        self.gridlayout_start_download_box_2.addWidget(self.lineedit_url_2, 0, 1, 1, 1)

        self.label_search_query_2 = QLabel(self.page_3)
        self.label_search_query_2.setObjectName(u"label_search_query_2")
        sizePolicy1 = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Fixed)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.label_search_query_2.sizePolicy().hasHeightForWidth())
        self.label_search_query_2.setSizePolicy(sizePolicy1)
        self.label_search_query_2.setMinimumSize(QSize(100, 0))

        self.gridlayout_start_download_box_2.addWidget(self.label_search_query_2, 4, 0, 1, 1)

        self.button_download_2 = QPushButton(self.page_3)
        self.button_download_2.setObjectName(u"button_download_2")
        self.button_download_2.setCursor(QCursor(Qt.PointingHandCursor))
        self.button_download_2.setStyleSheet(u"QPushButton {\n"
"    /* Base style */\n"
"    background-color: #7B1FA2; /* Purple background */\n"
"    border-style: outset;\n"
"    border-width: 2px;\n"
...
"}")
        ...
        self.gridlayout_start_download_box_2.addWidget(self.button_download_2, 0, 2, 1, 1)

        self.label_file_2 = QLabel(self.page_3)
        self.label_file_2.setObjectName(u"label_file_2")
        sizePolicy1.setHeightForWidth(self.label_file_2.sizePolicy().hasHeightForWidth())
        self.label_file_2.setSizePolicy(sizePolicy1)
        self.label_file_2.setMinimumSize(QSize(100, 0))

        self.gridlayout_start_download_box_2.addWidget(self.label_file_2, 3, 0, 1, 1)

        self.lineedit_search_query_2 = QLineEdit(self.page_3)
        self.lineedit_search_query_2.setObjectName(u"lineedit_search_query_2")
        sizePolicy.setHeightForWidth(self.lineedit_search_query_2.sizePolicy().hasHeightForWidth())
        self.lineedit_search_query_2.setSizePolicy(sizePolicy)
        self.lineedit_search_query_2.setMinimumSize(QSize(300, 0))

        self.gridlayout_start_download_box_2.addWidget(self.lineedit_search_query_2, 4, 1, 1, 1)

        self.button_open_file_2 = QPushButton(self.page_3)
        self.button_open_file_2.setObjectName(u"button_open_file_2")
        self.button_open_file_2.setCursor(QCursor(Qt.PointingHandCursor))
        self.button_open_file_2.setStyleSheet(u"QPushButton {\n"
"    /* Base style */\n"
"    background-color: #7B1FA2; /* Purple background */\n"
"    border-style: outset;\n"
"    border-width: 2px;\n"
...
"}")
        ...
        self.gridlayout_start_download_box_2.addWidget(self.button_open_file_2, 3, 2, 1, 1)

        self.button_search_videos_2 = QPushButton(self.page_3)
        self.button_search_videos_2.setObjectName(u"button_search_videos_2")
        self.button_search_videos_2.setCursor(QCursor(Qt.PointingHandCursor))
        self.button_search_videos_2.setStyleSheet(u"QPushButton {\n"
"    /* Base style */\n"
"    background-color: #7B1FA2; /* Purple background */\n"
"    border-style: outset;\n"
"    border-width: 2px;\n"
...
"}")
        ...
        self.gridlayout_start_download_box_2.addWidget(self.button_search_videos_2, 4, 2, 1, 1)

        self.label_model_url_2 = QLabel(self.page_3)
        self.label_model_url_2.setObjectName(u"label_model_url_2")
        sizePolicy1.setHeightForWidth(self.label_model_url_2.sizePolicy().hasHeightForWidth())
        self.label_model_url_2.setSizePolicy(sizePolicy1)
        self.label_model_url_2.setMinimumSize(QSize(100, 0))

        self.gridlayout_start_download_box_2.addWidget(self.label_model_url_2, 2, 0, 1, 1)

        self.label_url_2 = QLabel(self.page_3)
        self.label_url_2.setObjectName(u"label_url_2")
        sizePolicy1.setHeightForWidth(self.label_url_2.sizePolicy().hasHeightForWidth())
        self.label_url_2.setSizePolicy(sizePolicy1)
        self.label_url_2.setMinimumSize(QSize(100, 0))

        self.gridlayout_start_download_box_2.addWidget(self.label_url_2, 0, 0, 1, 1)
        ...
        self.lineedit_username_2 = QLineEdit(self.page_3)
        self.lineedit_username_2.setObjectName(u"lineedit_username_2")

        self.gridlayout_login_box_2.addWidget(self.lineedit_username_2, 0, 1, 1, 3)

        self.button_get_liked_videos_2 = QPushButton(self.page_3)
        self.button_get_liked_videos_2.setObjectName(u"button_get_liked_videos_2")
        self.button_get_liked_videos_2.setCursor(QCursor(Qt.PointingHandCursor))
        self.button_get_liked_videos_2.setStyleSheet(u"QPushButton {\n"
...
"}")
        ...
        self.gridlayout_login_box_2.addWidget(self.button_get_liked_videos_2, 3, 0, 1, 1)

        self.button_get_watched_videos_2 = QPushButton(self.page_3)
        self.button_get_watched_videos_2.setObjectName(u"button_get_watched_videos_2")
        self.button_get_watched_videos_2.setCursor(QCursor(Qt.PointingHandCursor))
        self.button_get_watched_videos_2.setStyleSheet(u"QPushButton {\n"
"    border: 2px solid #444;\n"
"    border-radius: 4px;\n"
"    padding: 5px;\n"
"    color: #DDD;\n"
...
"}")
        ...
        self.gridlayout_login_box_2.addWidget(self.button_get_watched_videos_2, 3, 1, 1, 1)

        self.label_password_2 = QLabel(self.page_3)
        self.label_password_2.setObjectName(u"label_password_2")

        self.gridlayout_login_box_2.addWidget(self.label_password_2, 1, 0, 1, 1)

        self.button_login_2 = QPushButton(self.page_3)
        self.button_login_2.setObjectName(u"button_login_2")
        self.button_login_2.setCursor(QCursor(Qt.PointingHandCursor))
        self.button_login_2.setStyleSheet(u"QPushButton {\n"
"    /* Base style */\n"
...
"}")
        ...
        self.gridlayout_login_box_2.addWidget(self.button_login_2, 2, 0, 1, 4)

        self.button_get_recommended_videos_2 = QPushButton(self.page_3)
        self.button_get_recommended_videos_2.setObjectName(u"button_get_recommended_videos_2")
        self.button_get_recommended_videos_2.setCursor(QCursor(Qt.PointingHandCursor))
        self.button_get_recommended_videos_2.setStyleSheet(u"QPushButton {\n"
"    border: 2px solid #444;\n"
"    border-radius: 4px;\n"
"    padding: 5px;\n"
"    color: #DDD;\n"
...
"}")
        ...
        self.gridlayout_login_box_2.addWidget(self.button_get_recommended_videos_2, 3, 2, 1, 1)

        self.label_username_2 = QLabel(self.page_3)
        self.label_username_2.setObjectName(u"label_username_2")

        self.gridlayout_login_box_2.addWidget(self.label_username_2, 0, 0, 1, 1)

        self.lineedit_password_2 = QLineEdit(self.page_3)
        self.lineedit_password_2.setObjectName(u"lineedit_password_2")
        self.lineedit_password_2.setEchoMode(QLineEdit.Password)

        self.gridlayout_login_box_2.addWidget(self.lineedit_password_2, 1, 1, 1, 3)
        ...
        self.radio_tree_show_title_2 = QRadioButton(self.page_3)
        self.radio_tree_show_title_2.setObjectName(u"radio_tree_show_title_2")
        sizePolicy1.setHeightForWidth(self.radio_tree_show_title_2.sizePolicy().hasHeightForWidth())
        self.radio_tree_show_title_2.setSizePolicy(sizePolicy1)

        self.gridLayout_7.addWidget(self.radio_tree_show_title_2, 0, 0, 1, 4)

        self.groupBox_4 = QGroupBox(self.page_3)
        self.groupBox_4.setObjectName(u"groupBox_4")
        self.gridLayout_34 = QGridLayout(self.groupBox_4)
        self.gridLayout_34.setObjectName(u"gridLayout_34")
        self.button_tree_unselect_all_2 = QPushButton(self.groupBox_4)
        self.button_tree_unselect_all_2.setObjectName(u"button_tree_unselect_all_2")
        self.button_tree_unselect_all_2.setStyleSheet(u"QPushButton {\n"
"    /* Base style */\n"
...
"")
        ...
        self.gridLayout_34.addWidget(self.button_tree_unselect_all_2, 0, 2, 1, 1)

        self.button_tree_select_all_2 = QPushButton(self.groupBox_4)
        self.button_tree_select_all_2.setObjectName(u"button_tree_select_all_2")
        self.button_tree_select_all_2.setStyleSheet(u"QPushButton {\n"
"    /* Base style */\n"
...
"")
        ...
        self.gridLayout_34.addWidget(self.button_tree_select_all_2, 0, 1, 1, 1)

        self.button_tree_download_2 = QPushButton(self.groupBox_4)
        self.button_tree_download_2.setObjectName(u"button_tree_download_2")
        self.button_tree_download_2.setStyleSheet(u"QPushButton {\n"
"    /* Base style */\n"
"    background-color: #7B1FA2; /* Purple background */\n"
"    border-style: outset;\n"
"    border-width: 2px;\n"
...
"")
        ...
        self.gridLayout_34.addWidget(self.button_tree_download_2, 0, 0, 1, 1)


        self.gridLayout_7.addWidget(self.groupBox_4, 2, 0, 1, 7)

        self.treeWidget_2 = QTreeWidget(self.page_3)
        ...
        self.treeWidget_2.setMinimumSize(QSize(1620, 100))

        self.gridLayout_7.addWidget(self.treeWidget_2, 1, 0, 1, 7)

        self.radio_tree_show_all_2 = QRadioButton(self.page_3)
        self.radio_tree_show_all_2.setObjectName(u"radio_tree_show_all_2")
        sizePolicy1.setHeightForWidth(self.radio_tree_show_all_2.sizePolicy().hasHeightForWidth())
        self.radio_tree_show_all_2.setSizePolicy(sizePolicy1)

        self.gridLayout_7.addWidget(self.radio_tree_show_all_2, 0, 4, 1, 3)
...
"border-radius: 5px;")
        ...
        sizePolicy.setHeightForWidth(self.progressbar_pornhub.sizePolicy().hasHeightForWidth())
        self.progressbar_pornhub.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.progressbar_hqporner.sizePolicy().hasHeightForWidth())
        self.progressbar_hqporner.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.lineedit_total.sizePolicy().hasHeightForWidth())
        self.lineedit_total.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.label_total.sizePolicy().hasHeightForWidth())
        self.label_total.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.label_debug.sizePolicy().hasHeightForWidth())
        self.label_debug.setSizePolicy(sizePolicy1)
...
"")
    ...
    def retranslateUi(self, Porn_Fetch_Widget):
        ...
        self.lineedit_file_2.setPlaceholderText(QCoreApplication.translate("Porn_Fetch_Widget", u"Click Open File to select a file, or write the location here and click Open File.    URLs need to be separated with a new line. Supports HQPorner and PornHub", None))
        self.lineedit_model_url_2.setPlaceholderText(QCoreApplication.translate("Porn_Fetch_Widget", u"Enter PornHub Model URL. This can be a Pornstar Account or a PornHub Channel. The videos will be listed down in the TreeWidget", None))
        self.button_model_2.setText(QCoreApplication.translate("Porn_Fetch_Widget", u"Get Videos", None))
        self.lineedit_url_2.setPlaceholderText(QCoreApplication.translate("Porn_Fetch_Widget", u"Enter PornHub or HQPorner Video URL", None))
        self.label_search_query_2.setText(QCoreApplication.translate("Porn_Fetch_Widget", u"Search Query:", None))
        self.button_download_2.setText(QCoreApplication.translate("Porn_Fetch_Widget", u"Download", None))
        self.label_file_2.setText(QCoreApplication.translate("Porn_Fetch_Widget", u"File:", None))
        self.lineedit_search_query_2.setPlaceholderText(QCoreApplication.translate("Porn_Fetch_Widget", u"Enter a Search Query for PornHub  You can define filters in the settings. The returned videos will be listed down below and you can select them.", None))
        self.button_open_file_2.setText(QCoreApplication.translate("Porn_Fetch_Widget", u"Open File", None))
        self.button_search_videos_2.setText(QCoreApplication.translate("Porn_Fetch_Widget", u"Get Videos", None))
        self.label_model_url_2.setText(QCoreApplication.translate("Porn_Fetch_Widget", u"Model URL:", None))
        self.label_url_2.setText(QCoreApplication.translate("Porn_Fetch_Widget", u"URL:", None))
        self.lineedit_username_2.setPlaceholderText(QCoreApplication.translate("Porn_Fetch_Widget", u"Enter your PornHub Username", None))
        self.button_get_liked_videos_2.setText(QCoreApplication.translate("Porn_Fetch_Widget", u"Get Liked videos", None))
        self.button_get_watched_videos_2.setText(QCoreApplication.translate("Porn_Fetch_Widget", u"Get watched videos", None))
        self.label_password_2.setText(QCoreApplication.translate("Porn_Fetch_Widget", u"Password:", None))
        self.button_login_2.setText(QCoreApplication.translate("Porn_Fetch_Widget", u"Login", None))
        self.button_get_recommended_videos_2.setText(QCoreApplication.translate("Porn_Fetch_Widget", u"Get recommended videos", None))
        self.label_username_2.setText(QCoreApplication.translate("Porn_Fetch_Widget", u"Username:", None))
        self.lineedit_password_2.setPlaceholderText(QCoreApplication.translate("Porn_Fetch_Widget", u"Enter your PornHub Password", None))
        self.radio_tree_show_title_2.setText(QCoreApplication.translate("Porn_Fetch_Widget", u"Only Title (a lot faster)", None))
        self.groupBox_4.setTitle("")
        self.button_tree_unselect_all_2.setText(QCoreApplication.translate("Porn_Fetch_Widget", u"Unselect all", None))
        self.button_tree_select_all_2.setText(QCoreApplication.translate("Porn_Fetch_Widget", u"Select all", None))
        self.button_tree_download_2.setText(QCoreApplication.translate("Porn_Fetch_Widget", u"Download Selected Videos", None))
        ...
        self.radio_tree_show_all_2.setText(QCoreApplication.translate("Porn_Fetch_Widget", u"Get Title, Author, Duration", None))
