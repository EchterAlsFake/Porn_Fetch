// sparkle_bridge.m
// Build as a .dylib and place into "Porn Fetch.app/Contents/Frameworks/"
// Explanation:
// Supporting automatic updates on macOS is very easy with the Sparkle Project
// See: https://sparkle-project.org/
// It provides an automatic interface in native Swift / Objective-C to update an existing
// application by providing a .dmg file (in my case)
// Thanks to ChatGPT, we can use this wrapper function and call it in Python using ctypes and
// interact with the shared library.
// Pure magic xD
// Tf how do people do multi line comments here??? holy shit
